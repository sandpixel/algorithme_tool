...
Blockly.JavaScript.init = function() {
    ...
    //J'ai enlevé pour éviter l'initialisation automatique : cas var et const
...
Blockly.JavaScript.lists_indexOf = function(a) {
    ...
    return[(Blockly.JavaScript.valueToCode(a, "VALUE", Blockly.JavaScript.ORDER_MEMBER) || "[]") + "." + b + "(" + c + ")", Blockly.JavaScript.ORDER_MEMBER]
    // J'ai enlevé le +1 pour que cela retourne correctement, c'est à dire, -1 quand pas trouvé
};
...
Blockly.JavaScript.controls_if = function(a) {
    for (var b = 0, c = Blockly.JavaScript.valueToCode(a, "IF" + b, Blockly.JavaScript.ORDER_NONE) || "false", d = Blockly.JavaScript.statementToCode(a, "DO" + b), e = "if (" + c + ") {\n" + d + "}", b = 1; b <= a.elseifCount_; b++)
        c = Blockly.JavaScript.valueToCode(a, "IF" + b, Blockly.JavaScript.ORDER_NONE) || "false", d = Blockly.JavaScript.statementToCode(a, "DO" + b), e += " else if (" + c + ") {\n" + d + "}";
    a.elseCount_ && (d = Blockly.JavaScript.statementToCode(a, "ELSE"), e += " else {\n" + d + "}");
    return e + "\n"
};
Blockly.JavaScript.logic_compare = function(a) {
    var b = {EQ: "==", NEQ: "!=", LT: "<", LTE: "<=", GT: ">", GTE: ">="}[a.getFieldValue("OP")], c = "==" == b || "!=" == b ? Blockly.JavaScript.ORDER_EQUALITY : Blockly.JavaScript.ORDER_RELATIONAL, d = Blockly.JavaScript.valueToCode(a, "A", c) || "0";
...
Blockly.JavaScript.controls_repeat = function(a) {
    var b = Number(a.getFieldValue("TIMES")), c = Blockly.JavaScript.statementToCode(a, "DO"), c = Blockly.JavaScript.addLoopTrap(c, a.id);
...
Blockly.JavaScript.controls_repeat_ext = function(a) {
    var b = Blockly.JavaScript.valueToCode(a, "TIMES", Blockly.JavaScript.ORDER_ASSIGNMENT) || "0", c = Blockly.JavaScript.statementToCode(a, "DO"), c = Blockly.JavaScript.addLoopTrap(c, a.id);
    a = "";
...
Blockly.JavaScript['controls_DoWhile'] = function(block) {
  ...
  var code = 'do{\n '+ statements_do + '}while ('+value_bool+')\n';
  return code;
};
// Fin nouveau bloc - Do while 
// 
// 
...
//            c = Blockly.JavaScript.valueToCode(a, "FROM", Blockly.JavaScript.ORDER_ASSIGNMENT) || "A",
//            d = Blockly.JavaScript.valueToCode(a, "TO", Blockly.JavaScript.ORDER_ASSIGNMENT) || "B",
//            e = Blockly.JavaScript.valueToCode(a, "BY", Blockly.JavaScript.ORDER_ASSIGNMENT) || "C",
...
//Nouvelle programmation de la boucle for
...
Blockly.JavaScript.controls_for = function(a) {
    ...
    var code = 'for('+b+'='+c+';'+b+''+signe+''+d+';'+increment+'){\n\ '+f+'\n\}; \n\ ';
    return code;
...
Blockly.JavaScript.math_arithmetic = function(a) {
    var b = {
        ...
        POWER: [null, Blockly.JavaScript.ORDER_COMMA]}[a.getFieldValue("OP")], c = b[0], b = b[1], 
...
//  var code;
//  if(dropdown_operation !== 'POWER'){
//    code = '('+value_a + dropdown_operation + value_b+ ')';
//  }else{
//    code = '(Math.pow('+value_a+','+value_b+'))';
//  }
...
Blockly.JavaScript.math_single = function(a) {
    ...
    switch (b) {
        ...
        case "ROUNDDOWN":
            ...
            break;
       case "ROUNDCURRENCY":
           //c = "Math.round(" + a + "/0.05)*0.05";
            c = "(Math.round(" + a + "*20)/20).toFixed(2)";
            break;
        case "SIN":
...
Blockly.JavaScript.math_number_property = function(a) {
    ...
    if ("PRIME" == c)
        return d = Blockly.JavaScript.provideFunction_("math_isPrime", ["function " + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ + "(n) {", "  // https://en.wikipedia.org/wiki/Primality_test#Naive_methods", "  if (n == 2 || n == 3) {", "    return true;", "  }", "  // False if n is NaN, negative, is 1, or not whole.", "  // And false if n is divisible by 2 or 3.",
...
Blockly.JavaScript.text_join = function(a) {
    ...
    if (2 == a.itemCount_)
        return b = Blockly.JavaScript.valueToCode(a, "ADD0", Blockly.JavaScript.ORDER_NONE) || "''", a = Blockly.JavaScript.valueToCode(a, "ADD1", Blockly.JavaScript.ORDER_NONE) || "''", ["String(" + b + ") + String(" + a + ")", Blockly.JavaScript.ORDER_ADDITION];
...
Blockly.JavaScript.text_charAt = function(block) {
  ...
  // TODO: Assemble JavaScript into code variable.
  var code = ''+value_texte+'.charAt('+value_index+')';
...
Blockly.JavaScript.text_getSubstring = function(block) {
  var value_texte = Blockly.JavaScript.valueToCode(block, 'texte', Blockly.JavaScript.ORDER_ATOMIC);
  var value_indexdebut = Blockly.JavaScript.valueToCode(block, 'indexdebut', Blockly.JavaScript.ORDER_ATOMIC);
  var value_indexfin = Blockly.JavaScript.valueToCode(block, 'indexfin', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = ''+value_texte+'.substring('+value_indexdebut+','+value_indexfin+')';
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.JavaScript.ORDER_NONE];
};
...
Blockly.JavaScript.text_trim = function(a) {
    var b = {LEFT: ".trimLeft()", RIGHT: ".trimRight()", BOTH: ".trim()"}[a.getFieldValue("MODE")];
...
//    return Blockly.JavaScript.variableDB_.getName(a.getFieldValue("VAR"), Blockly.Variables.NAME_TYPE) + " = " + b + ";\n"
  var value_const = Blockly.JavaScript.valueToCode(a, "VALUE", Blockly.JavaScript.ORDER_ASSIGNMENT) || "0";
  var variable_constante = Blockly.JavaScript.variableDB_.getName(a.getFieldValue("VAR"), Blockly.Variables.NAME_TYPE)
  //TODO: Assemble JavaScript into code variable.
  var code = 'var '+ variable_constante + ' = '+ value_const + ';\n' ;
  return code;

};

//test
Blockly.JavaScript['constante_set'] = function(block) {
  var value_const = Blockly.JavaScript.valueToCode(block, "VALUE", Blockly.JavaScript.ORDER_ASSIGNMENT) || "0";
  var variable_constante = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('CONST'), Blockly.Variables.NAME_TYPE);
  //TODO: Assemble JavaScript into code variable.
  var code = 'const '+ variable_constante + ' = '+ value_const + ';\n' ;
  return code;
//    var b = Blockly.JavaScript.valueToCode(a, "VALUE", Blockly.JavaScript.ORDER_ASSIGNMENT) || "0";
//    return Blockly.JavaScript.variableDB_.getName(a.getFieldValue("VAR"), Blockly.Variables.NAME_TYPE) + " = " + b + ";\n"
};
Blockly.JavaScript['constante_get'] = function(block) {
return[Blockly.JavaScript.variableDB_.getName(block.getFieldValue("VAR"), Blockly.Variables.NAME_TYPE), Blockly.JavaScript.ORDER_ATOMIC]
};

///// Tableau test

Blockly.JavaScript['tableau'] = function(block) {
  var value_tableau = Blockly.JavaScript.valueToCode(block, 'tableau', Blockly.JavaScript.ORDER_ATOMIC);
  var value_index = Blockly.JavaScript.valueToCode(block, 'index', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = value_tableau + '['+value_index+']';
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.JavaScript['tableau_ajout'] = function(block) {
  ...
  // TODO: Assemble JavaScript into code variable.
  var code = value_liste + '['+value_index+'] ='+ value_valeur+ ';\n' ;
  return code;
};
...
// Capture le temps de la machine en ms
Blockly.JavaScript['catch_time'] = function(block) {
  // TODO: Assemble JavaScript into code variable.
...
//Retour à la ligne
Blockly.JavaScript['line_return'] = function(block) {
  // TODO: Assemble JavaScript into code variable.
  var code = ' "\\n"' ;
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.JavaScript.ORDER_NONE];
...
//Supprimer un élément d'une liste selon index
Blockly.JavaScript['list_removeitem'] = function(block) {
  ...
  // liste.splice(index, nb à supprimer);
  var code = list+'.splice('+index+',1);\n';
  return code;
};

//Pour arrondir un nombre selon précision donnée
Blockly.JavaScript['arrondi_precision'] = function(block) {
  var nombre = Blockly.JavaScript.valueToCode(block, 'nombre', Blockly.JavaScript.ORDER_ATOMIC);
  var decimale = Blockly.JavaScript.valueToCode(block, 'decimale', Blockly.JavaScript.ORDER_ATOMIC);
  var code = nombre+'.toFixed('+decimale+')';
  return [code, Blockly.JavaScript.ORDER_NONE];
};

//Bloc pour commentaire
Blockly.JavaScript['commentaire'] = function(block) {
  var commentaire = block.getFieldValue('NAME');
  var code = '//'+commentaire+ '\n';
  return code;
};