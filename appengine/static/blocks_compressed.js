...
Blockly.Blocks.lists_create_with = {init: function() {
        ...
        for (var b =
                0; b < this.itemCount_; b++)
            this.removeInput("ADD" + b);
        this.itemCount_ = parseInt(a.getAttribute("items"), 10);
        for (b = 0; b < this.itemCount_; b++)
            a = this.appendValueInput("ADD" + b), 0 == b && a.appendField(Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH);
        ...
        for (a = a.getInputTargetBlock("STACK"); a; )
            b = this.appendValueInput("ADD" + this.itemCount_), 0 == this.itemCount_ && b.appendField(Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH), a.valueConnection_ && b.connection.connect(a.valueConnection_), this.itemCount_++, a = a.nextConnection &&
...
///////////////////////////// Test liste
//////////////////////////////
Blockly.Blocks['tableau'] = {
  init: function() {
    this.setHelpUrl('http://www.commentcamarche.net/contents/587-javascript-les-tableaux');
    this.appendValueInput("tableau")
        .setCheck("Array")
        .appendField("Dans la liste");
    this.appendValueInput("index")
        .setCheck("Number")
        .appendField("récupérer la valeur à l’index");
    this.setInputsInline(true);
    this.setInputsInline(true);
    this.setOutput(true);
    this.setTooltip('Voir Aide');
    this.setColour(260);
...
Blockly.Blocks['tableau_ajout'] = {
  init: function() {
    this.setHelpUrl('http://www.example.com/');
    this.appendValueInput("liste")
        .setCheck("Array")
        .appendField("Dans la liste");
    this.appendValueInput("index")
        .setCheck("Number")
        .appendField("mettre à l’index");
...
Blockly.Blocks.logic_compare = {init: function() {
        ...
        this.setColour(120);
        this.setOutput(!0, "Boolean");
        this.appendValueInput("A").setCheck(['String', 'Number','Boolean']);
        this.appendValueInput("B").appendField(new Blockly.FieldDropdown(a), "OP").setCheck(['String', 'Array','Number','Boolean']);
        this.setInputsInline(!0);
        var b = this;
        this.setTooltip(function() {
            var a =
...
Blockly.Blocks.logic_operation = {init: function() {
        ...
        this.setTooltip(function() {
            ...
            return{AND: Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND,
...
//controls_DoWhile
Blockly.Blocks.controls_DoWhile = {init: function() {
        this.setHelpUrl('http://www.google.ch');
        this.setPreviousStatement(true);
        this.setColour(160);
        this.appendStatementInput("DO").appendField(Blockly.Msg.CONTROLS_FOR_INPUT_DO).setAlign(Blockly.ALIGN_RIGHT);
        this.appendValueInput("BOOL").setCheck("Boolean").appendField(Blockly.Msg.CONTROLS_DOWHILE_OPERATOR_WHILE);
        this.setNextStatement(true);
...
Blockly.Blocks.controls_flow_statements = {init: function() {
        ...
        this.setTooltip(function() {
            ...
            return{BREAK: Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK,
                CONTINUE: Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE}[a]
        })
    }, onchange: function() {
        if (this.workspace) {
            var a = !1, b = this;
...
Blockly.Blocks.math_round = {init: function() {
        var a = [[Blockly.Msg.MATH_ROUND_OPERATOR_ROUND, "ROUND"], [Blockly.Msg.MATH_ROUND_OPERATOR_ROUNDUP, "ROUNDUP"],
            [Blockly.Msg.MATH_ROUND_OPERATOR_ROUNDDOWN, "ROUNDDOWN"], [Blockly.Msg.MATH_ROUND_OPERATOR_ROUNDCURRENY, "ROUNDCURRENCY"]];
...
Blockly.Blocks.math_on_list = {init: function() {
        ...
        this.setTooltip(function() {
            var a = b.getFieldValue("OP");
            return{SUM: Blockly.Msg.MATH_ONLIST_TOOLTIP_SUM, MIN: Blockly.Msg.MATH_ONLIST_TOOLTIP_MIN, MAX: Blockly.Msg.MATH_ONLIST_TOOLTIP_MAX, AVERAGE: Blockly.Msg.MATH_ONLIST_TOOLTIP_AVERAGE, MEDIAN: Blockly.Msg.MATH_ONLIST_TOOLTIP_MEDIAN,
                MODE: Blockly.Msg.MATH_ONLIST_TOOLTIP_MODE, STD_DEV: Blockly.Msg.MATH_ONLIST_TOOLTIP_STD_DEV, RANDOM: Blockly.Msg.MATH_ONLIST_TOOLTIP_RANDOM}[a]
        })
    }};
...
Blockly.Blocks.procedures_defnoreturn = {init: function() {
        ...
        if (null !== a && (a = "TRUE" == a, this.hasStatements_ != a))
            if (a)
                this.setStatements_(!0), a = this.getInput("STACK").connection, a.targetConnection || !this.statementConnection_ || this.statementConnection_.targetConnection || this.statementConnection_.sourceBlock_.workspace != this.workspace ? this.statementConnection_ = null : a.connect(this.statementConnection_);
            else {
                a =
        ...
        if (!this.isCollapsed())
            for (e = 0; e < this.arguments_.length; e++)
                b = {enabled: !0}, c = this.arguments_[e], b.text = Blockly.Msg.VARIABLES_SET_CREATE_GET.replace("%1", c), d = goog.dom.createDom("field", null, c), d.setAttribute("name", "VAR"), d = goog.dom.createDom("block", null, d), d.setAttribute("type",
...
Blockly.Blocks.procedures_defreturn = {init: function() {
    ...
    compose: Blockly.Blocks.procedures_defnoreturn.compose, dispose: Blockly.Blocks.procedures_defnoreturn.dispose, getProcedureDef: function() {
...
Blockly.Blocks.procedures_callnoreturn = {init: function() {
        ...
        if ((b = Blockly.Procedures.getDefinition(b, this.workspace)) && b.mutator.isVisible())
...
Blockly.Blocks.procedures_callreturn = {init: function() {
        ...
        this.arguments_ = [];
        this.quarkArguments_ = this.quarkConnections_ = null
    }, getProcedureCall: Blockly.Blocks.procedures_callnoreturn.getProcedureCall, renameProcedure: Blockly.Blocks.procedures_callnoreturn.renameProcedure,
...
Blockly.Blocks.text_join = {init: function() {
        ...
        this.itemCount_ = parseInt(a.getAttribute("items"), 10);
        for (b = 0; b < this.itemCount_; b++)
            a = this.appendValueInput("ADD" + b), 0 == b && a.appendField(Blockly.Msg.TEXT_JOIN_TITLE_CREATEWITH);
        ...
        this.itemCount_ = 0;
        for (a = a.getInputTargetBlock("STACK"); a; )
            b = this.appendValueInput("ADD" + this.itemCount_), 0 == this.itemCount_ && b.appendField(Blockly.Msg.TEXT_JOIN_TITLE_CREATEWITH),
...
Blockly.Blocks.text_charAt = {init: function() {
    ...
    this.appendValueInput("index")
        .setCheck("Number")
        .appendField("obtenir le caractère à l’index");
    this.setInputsInline(true);
    this.setOutput(true);
    this.setColour(230);
    this.setTooltip('');
...
Blockly.Blocks.text_getSubstring = {init: function() {
    this.appendValueInput("texte")
        .appendField("dans le texte ");
    this.appendValueInput("indexdebut")
        .setCheck("Number")
        .appendField("obtenir la sous-chaîne depuis l’index");
    this.appendValueInput("indexfin")
        .setCheck("Number")
        .appendField("jusqu’à l’index");
    this.setInputsInline(true);
...
// Test
Blockly.Blocks.constante_get = {init: function() {
        this.setColour(196);
        this.appendDummyInput().appendField(Blockly.Msg.VARIABLES_GET_TITLE).appendField(new Blockly.FieldVariable(Blockly.Msg.CONST_DEFAULT_NAME), "VAR").appendField(Blockly.Msg.VARIABLES_GET_TAIL);
        this.setOutput(!0);
        this.setTooltip(Blockly.Msg.VARIABLES_GET_TOOLTIP);
        this.contextMenuMsg_ = Blockly.Msg.VARIABLES_GET_CREATE_SET;
        this.contextMenuType_ = "variables_set"
...
Blockly.Blocks.constante_set= {init: function() {
        this.setColour(196);
        this.interpolateMsg(Blockly.Msg.VARIABLES_SET_TITLE + " %1 " + Blockly.Msg.VARIABLES_SET_TAIL + " %2", ["CONST", new Blockly.FieldVariable(Blockly.Msg.CONST_DEFAULT_NAME)], ["VALUE", null, Blockly.ALIGN_RIGHT], Blockly.ALIGN_RIGHT);
        this.setPreviousStatement(!0);
        this.setNextStatement(!0);
        this.setTooltip(Blockly.Msg.VARIABLES_SET_TOOLTIP);
        this.contextMenuMsg_ = Blockly.Msg.VARIABLES_SET_CREATE_GET;
        ...
        Blockly.Names.equals(a, this.getFieldValue("CONST")) && this.setFieldValue(b, "CONST")
    }, customContextMenu: Blockly.Blocks.variables_get.customContextMenu};


///
Blockly.Blocks['catch_time'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("temps actuel (ms)");
...
Blockly.Blocks['line_return'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("retour à la ligne");
    this.setOutput(true, "String");
    this.setTooltip('');
    this.setColour(230);
  }
...
// Block qui permet de supprimer une valeur dans une liste selon index donn�
Blockly.Blocks['list_removeitem'] = {
  init: function() {
    this.setColour(260);
    ...
    this.appendValueInput("index")
        .setCheck("Number")
        .appendField("supprimer la valeur à l'index");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
  }
...
// Block qui permet d'arrondir un nombre � une pr�cision donn�e

Blockly.Blocks['arrondi_precision'] = {
  init: function() {
    this.setColour(210);
    this.appendValueInput("nombre")
        .setCheck("Number")
        .appendField("arrondir");
    this.appendValueInput("decimale")
        .setCheck("Number")
        .appendField("à");
    this.appendDummyInput()
        .appendField("décimale(s)");
    this.setInputsInline(true);
    this.setOutput(true);
  }
};

//Bloc pour commentaire
